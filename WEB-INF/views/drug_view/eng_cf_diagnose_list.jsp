...
<body class="gray-bg">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <table id="engCfList" data-toggle="table"
					data-url="/kettle/engCfDiagnose/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="cfId">处方ID号</th>
							<th data-field="diagnose">诊断</th>
							<th data-field="diagnoseDate" data-formatter="editTimeFormatter">诊断时间</th>
	...
	<script>
	    ...
	    function search(){
	    	$('#engCfList').bootstrapTable('refresh', "kettle/engCfDiagnose/getListPage");
	    };
