...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="orderDrugDailyFeeEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="orderDrugDailyFeeStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="orderDrugDailyFeeList" data-toggle="table"
					data-url="kettle/orderDrugDailyFee/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="totalQtyUnit">总数量单位</th>
							<th data-field="totalFee">总费用</th>
							<th data-field="feeDate">收费时间</th>
						</tr>
					</thead>
				</table>
            </div>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#orderDrugDailyFeeStartDate").val();
	    	var $endDate = $("#orderDrugDailyFeeEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#orderDrugDailyFeeList').bootstrapTable('refresh', "kettle/orderDrugDailyFee/getListPage");
	    };
