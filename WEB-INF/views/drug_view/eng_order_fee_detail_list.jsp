...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engOrderFeeDetailEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engOrderFeeDetailStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engOrderFeeDetailList" data-toggle="table"
					data-url="/kettle/engOrderFeeDetail/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="payFlag">退费标志</th>
							<th data-field="orderId">住院就诊流水号</th>
							<th data-field="orderItemId">相关医嘱ID</th>
							<th data-field="patientNo">病人ID</th>
							<th data-field="patientName">病人姓名</th>
							<th data-field="invoiceNo">发票号</th>
							<th data-field="chargeTime">收费/退费时间</th>
							<th data-field="itemType">明细项目费用类别</th>
							<th data-field="itemCode">明细编码</th>
							<th data-field="itemName">明细项目名称</th>
							<th data-field="itemQty">明细项目数量</th>
							<th data-field="itemQtyUnit">明细项目单位</th>
							...
							<th data-field="executeDepartId">执行科室ID</th>
							<th data-field="executeDepartment">执行科室名称</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engOrderFeeDetailStartDate").val();
	    	var $endDate = $("#engOrderFeeDetailEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engOrderFeeDetailList').bootstrapTable('refresh', "kettle/engOrderFeeDetail/getListPage");
	    };
