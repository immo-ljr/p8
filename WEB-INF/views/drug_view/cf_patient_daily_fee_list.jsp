...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="cfPatientDailyFeeEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="cfPatientDailyFeeStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="cfPatientDailyFeeList" data-toggle="table"
					data-url="kettle/cfPatientDailyFee/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="cfId">门诊处方ID</th>
							<th data-field="patientNo">患者号</th>
							<th data-field="patientName">患者姓名</th>
							<th data-field="totalFee">患者每日总费用</th>
							<th data-field="totalDrugFee">患者每日总药品费用</th>
							<th data-field="feeDate">收费日期</th>
						</tr>
					</thead>
				</table>
            </div>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#cfPatientDailyFeeStartDate").val();
	    	var $endDate = $("#cfPatientDailyFeeEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#cfPatientDailyFeeList').bootstrapTable('refresh', "kettle/cfPatientDailyFee/getListPage");
	    };
