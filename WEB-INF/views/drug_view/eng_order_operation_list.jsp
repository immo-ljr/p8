...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engOrderOperationEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engOrderOperationStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engOrderOperationList" data-toggle="table"
					data-url="/kettle/engOrderOperation/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="code">手术编码(ICD9-CM3)</th>
							<th data-field="name">手术名称</th>
							<th data-field="startTime">手术开始时间</th>
							<th data-field="endTime">手术结束时间</th>
							<th data-field="incisionType">切口类别</th>
							<th data-field="incisionStatus">愈合状态</th>
							<th data-field="inplant">是否有植入物</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engOrderOperationStartDate").val();
	    	var $endDate = $("#engOrderOperationEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engOrderOperationList').bootstrapTable('refresh', "kettle/engOrderOperation/getListPage");
	    };
