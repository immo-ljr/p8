        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<div class="col-sm-6 float-left">	
	            	<a href="index/rAddJobUI" class="btn btn-w-m btn-info" type="button">
    ...
    <script>
	    ...
	    window.actionEvents = {	    		
	    		...
	    		'click #edit' : function(e, value, row, index) {
	    			var jobId = row.id;
	    			location.href = "index/editJobUI?jobId=" + jobId;
	    		},
		    ...
		    function search(){
		    	$('#jobList').bootstrapTable('refresh', "index/listJobUI");
		    }
    </script>
</body>
</html>