	...
	<script>
	    ...
	    window.actionEvents = {				
	    		'click #edit' : function(e, value, row, index) {
	    			var repositoryId = row.id;
	    			location.href = "index/editRepositoryUI?id=" + repositoryId;
	    		},
