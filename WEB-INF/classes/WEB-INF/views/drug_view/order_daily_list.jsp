...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="orderDailyEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="orderDailyStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="orderDailyList" data-toggle="table"
					data-url="kettle/orderDaily/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="outPatientNum">出院总人数</th>
							<th data-field="inPatientNum">入院总人数</th>
							<th data-field="livePatientNum">在院总人数</th>
							<th data-field="outPatientFee">出院病人总费用</th>
							<th data-field="outPatientDrugFee">出院病人总药品费用</th>
							<th data-field="totalFee">总费用</th>
							<th data-field="totalDrugFee">药品总费用</th>
							<th data-field="tjDate">统计时间</th>
						</tr>
					</thead>
				</table>
            </div>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#orderDailyStartDate").val();
	    	var $endDate = $("#orderDailyEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#orderDailyList').bootstrapTable('refresh', "kettle/orderDaily/getListPage");
	    };
