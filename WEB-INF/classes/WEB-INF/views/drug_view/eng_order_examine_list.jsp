...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engOrderExamineEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engOrderExamineStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engOrderExamineList" data-toggle="table"
					data-url="kettle/engOrderExamine/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="examItemId">检验项目ID</th>
							<th data-field="examItemName">检验项目名称</th>
							<th data-field="sendTime">开具时间</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engOrderExamineStartDate").val();
	    	var $endDate = $("#engOrderExamineEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engOrderExamineList').bootstrapTable('refresh', "kettle/engOrderExamine/getListPage");
	    };
