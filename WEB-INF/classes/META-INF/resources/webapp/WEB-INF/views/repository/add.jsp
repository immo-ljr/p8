            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="RepositoryForm">            		             
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-7">
	                        <input id="repositoryName" name="repositoryName" type="text" value="kettle_mysql" placeholder="请输入资源库名称" class="form-control" aria-required="true">
	                    </div>
	                </div>	
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">登录资源库用户名：</label>
	                    <div class="col-sm-7">
	                        <input id="repositoryUsername" name="repositoryUsername" type="text" value="admin" placeholder="请输入登录资源库用户名" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">登录资源库密码：</label>
	                    <div class="col-sm-7">
	                        <input id="repositoryPassword" name="repositoryPassword" type="password" value="admin" placeholder="请输入登录资源库密码" class="form-control" aria-required="true">
	                    </div>
	                </div>	
	                <div class="form-group">
            		...
            		<div class="form-group">
	                    ...
	                    <div class="col-sm-7">
	                        <input id="databaseHost" name="databaseHost" type="text" value="127.0.0.1" placeholder="请输入资源库数据库主机名或者IP地址" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">资源库数据库端口号：</label>
	                    <div class="col-sm-7">
	                        <input id="databasePort" name="databasePort" type="text" value="3308" placeholder="请输入资源库数据库端口号" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">资源库数据库名称：</label>
	                    <div class="col-sm-7">
	                        <input id="databaseName" name="databaseName" type="text" value="kettle_test" placeholder="请输入资源库数据库名称" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">资源库数据库登录账号：</label>
	                    <div class="col-sm-7">
	                        <input id="databaseUsername" name="databaseUsername" type="text" value="root" placeholder="请输入资源库数据库登录账号" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">资源库数据库登录密码：</label>
	                    <div class="col-sm-7">
	                        <input id="databasePassword" name="databasePassword" type="password" value="root" placeholder="请输入资源库数据库登录密码" class="form-control" aria-required="true">
	                    </div>
	                </div>            
	                <div class="form-group">
