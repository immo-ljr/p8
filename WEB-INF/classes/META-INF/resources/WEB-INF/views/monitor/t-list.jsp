        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <table id="transMonitorList" data-toggle="table"
					data-url="kettle/kTransMonitor/getListJoinPage"
					...
					<thead>
						<tr>
							...
							<th data-field="runStatus" data-formatter="transStatusFormatter">导数状态</th>
	...
	<script>
		$(document).ready(function () {
			$.ajax({
		        type: 'POST',
		        async: false,
		        url: 'kettle/kTransMonitor/getAllMonitorTransCount',
		        data: {},
			...
			$.ajax({
		        type: 'POST',
		        async: false,
		        url: 'kettle/kTransMonitor/getAllSuccessCount',
		        data: {},
		        success: function (datas) {
		        	var data =datas.data;
		        	console.log(data);
			...
			$.ajax({
		        type: 'POST',
		        async: false,
		        url: 'kettle/kTransMonitor/getAllFailCount',
		        data: {},
		        success: function (datas) {
		        	var data = datas.data;
		        	$("#allFail").text(data);
	    ...
	    window.actionEvents = {				
    		'click #viewDetail' : function(e, value, row, index) {
    			location.href="index/recordListUI?transId=" + row.monitorTrans+"&id="+row.id+"&startDate=&endDate=";    			
    		},
    	};
