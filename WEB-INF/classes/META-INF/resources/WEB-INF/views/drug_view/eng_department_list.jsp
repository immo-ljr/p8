...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engDepartmentEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engDepartmentStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engDepartmentList" data-toggle="table"
					data-url="kettle/engDepartment/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="abbr">科室简称</th>
							<th data-field="type">科室类型</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engDepartmentStartDate").val();
	    	var $endDate = $("#engDepartmentEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engDepartmentList').bootstrapTable('refresh', "kettle/engDepartment/getListPage");
	    };
