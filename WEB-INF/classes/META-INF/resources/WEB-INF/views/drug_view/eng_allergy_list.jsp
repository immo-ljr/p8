...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engAllergyEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engAllergyStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engAllergyList" data-toggle="table"
					data-url="kettle/engAllergy/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="name">过敏药物名称</th>
							<th data-field="createDate" data-formatter="editTimeFormatter">创建时间</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engAllergyStartDate").val();
	    	var $endDate = $("#engAllergyEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engAllergyList').bootstrapTable('refresh', "kettle/engAllergy/getListPage");
	    };
