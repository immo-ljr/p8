...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="orderPatientDailyFeeEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="orderPatientDailyFeeStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="orderPatientDailyFeeList" data-toggle="table"
					data-url="kettle/orderPatientDailyFee/getListPage"	
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#orderPatientDailyFeeStartDate").val();
	    	var $endDate = $("#orderPatientDailyFeeEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#orderPatientDailyFeeList').bootstrapTable('refresh', "kettle/orderPatientDailyFee/getListPage");
	    };
