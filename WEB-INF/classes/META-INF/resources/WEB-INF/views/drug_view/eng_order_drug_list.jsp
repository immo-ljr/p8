...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engOrderDrugEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engOrderDrugStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engOrderDrugList" data-toggle="table"
					data-url="kettle/engOrderDrug/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="startTime">药嘱开始时间</th>
							<th data-field="endTime">药嘱结束时间</th>
							<th data-field="continueDay">用药持续时间</th>
							<th data-field="presDateTime">开具时间</th>
							...
							<th data-field="docTitle">医师职称</th>
							<th data-field="presDepartId">开具科室id</th>
							<th data-field="presDepartment">开具科室</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engOrderDrugStartDate").val();
	    	var $endDate = $("#engOrderDrugEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engOrderDrugList').bootstrapTable('refresh', "kettle/engOrderDrug/getListPage");
	    };
