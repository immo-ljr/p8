...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="cfDoctorDailyEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="cfDoctorDailyStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="cfDoctorDailyList" data-toggle="table"
					data-url="kettle/cfDoctorDaily/getListPage"	
					data-query-params=queryParams data-query-params-type="limit"
					data-pagination="true"
					data-side-pagination="server" data-pagination-loop="false">
					<thead>
						<tr>
							<th data-field="id">编辑</th>
							<th data-field="docId">医生ID</th>
							<th data-field="docName">医生名称</th>
							<th data-field="patientTimeNum">每日接诊人次数</th>
							<th data-field="cfNum">每日开具处方数</th>
							<th data-field="presDate">处方开具日期</th>
						</tr>
					</thead>
				</table>
            </div>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#cfDoctorDailyStartDate").val();
	    	var $endDate = $("#cfDoctorDailyEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#cfDoctorDailyList').bootstrapTable('refresh', "kettle/cfDoctorDaily/getListPage");
	    };
