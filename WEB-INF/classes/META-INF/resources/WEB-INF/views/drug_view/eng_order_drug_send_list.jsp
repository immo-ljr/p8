...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="engOrderDrugSendEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="engOrderDrugSendStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="engOrderDrugSendList" data-toggle="table"
					data-url="kettle/engOrderDrugSend/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="admin_route">给药途径</th>
							...
							<th data-field="sendDataTime" data-formatter="editTimeFormatter">发药时间</th>
							<th data-field="docId">医师工号</th>
							<th data-field="docName">医师姓名</th>
							<th data-field="useDepartId">用药科室ID</th>
							<th data-field="useDepartment">用药科室</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#engOrderDrugSendStartDate").val();
	    	var $endDate = $("#engOrderDrugSendEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#engOrderDrugSendList').bootstrapTable('refresh', "kettle/engOrderDrugSend/getListPage");
	    };
