...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="drugConvertEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="drugConvertStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="drugConvertList" data-toggle="table"
					data-url="kettle/drugConvert/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="unitNum">单位数值</th>
							<th data-field="unit">单位</th>
							<th data-field="convertNum">转换后数值</th>
							<th data-field="convertUnit">转换后单位</th>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#drugConvertStartDate").val();
	    	var $endDate = $("#drugConvertEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#drugConvertList').bootstrapTable('refresh', "kettle/drugConvert/getListPage");
	    };
