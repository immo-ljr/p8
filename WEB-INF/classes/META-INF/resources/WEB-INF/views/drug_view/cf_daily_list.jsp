...
<body class="gray-bg">
	            	...
	            	<button onclick="search()" class="right btn btn-w-m btn-info" type="button">
           			...
           			<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
						    <input size="16" type="text"  id="cfDailyEndDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
					<div class="right col-sm-3">
	           			<div class="input-append date form_datetime">
	           				 <input size="16" type="text"  id="cfDailyStartDate" readonly>
						    <span class="add-on"><i class="icon-th"></i></span>
						</div>
					</div>
            	</div>
                <table id="cfDailyList" data-toggle="table"
					data-url="kettle/cfDaily/getListPage"	
					...
					<thead>
						<tr>
							...
							<th data-field="patientNum">每日就诊总人数</th>
							<th data-field="patientTimeNum">每日就诊总人次数</th>
							<th data-field="cfCount">每日总处方数</th>
							<th data-field="totalFee">每日总费用</th>
							<th data-field="totalDrugFee">每日总药品费用</th>
							<th data-field="tjDate">统计日期</th>
						</tr>
					</thead>
				</table>
            </div>
	...
	<script>
	    ...
	    function queryParams(params) {
	    	var $startDate = $("#cfDailyStartDate").val();
	    	var $endDate = $("#cfDailyEndDate").val();
	    	var temp = { limit: 10, offset: params.offset/10+1, startDate:$startDate, endDate:$endDate };
	        return temp;
	    };
	    
	    function search(){
	    	$('#cfDailyList').bootstrapTable('refresh', "kettle/cfDaily/getListPage");
	    };
